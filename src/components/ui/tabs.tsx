  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-white dark:data-[state=active]:text-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-card data-[state=active]:text-foreground",
