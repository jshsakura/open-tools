...
const OUTPUT_NAME = "muted.mp4"
const OUTPUT_MIME = "video/mp4"

export function VideoMute() {
    const t = useTranslations("VideoMute")
        ...
        <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="w-full lg:w-1/2">
                <GlassCard className="h-full rounded-2xl p-6 flex flex-col gap-8 relative">
                    ...
                    {/* Fast / lossless note */}
                    <div className="flex gap-3 items-start rounded-xl border border-border/50 bg-secondary/20 p-4">
                        <Zap className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                        <div>
                            <p className="font-semibold text-sm">{t("losslessTitle")}</p>
